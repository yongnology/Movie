...
function changePhone3(){
    ...
    if(phone3.length === 4){
      ...
      document.getElementById("sendMessage").setAttribute("style","background-color:#6e3abb;color:#fff")
...
const getToken = () => {
  ...
  // 인증확인 버튼 활성화
  document.getElementById("completion").setAttribute("style","background-color:#6e3abb;color:#fff")
...
function checkCompletion(){
  ...
  document.getElementById("signUpButton").setAttribute("style","background-color:#6e3abb;color:#fff")
}
...
function signUpCheck(){
  ...
  let mkt_agree = document.getElementById("mkt_agree").checked
  let mkt_disagree = document.getElementById("mkt_disagree").checked
  let check = true;
  ...
  // 생년월일
  if(birth===""){
    document.getElementById("birthError").innerHTML="생년월일 올바르지 않습니다."
    check = false
  }else{
  ...
  // 마케팅 동의 비동의
  if(!mkt_agree && !mkt_disagree){
    document.getElementById("marketingError").innerHTML="동의 또는 비동의를 선택해주세요."
    check = false
  }else{
    document.getElementById("marketingError").innerHTML=""
  }
